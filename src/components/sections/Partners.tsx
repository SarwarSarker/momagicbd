...
const partnerLogos = [
  ...
  {
    name: "MARS Technology",
    logo: "/images/partners/MARS_Technology_logo.png",
  },
...
const Partners: React.FC = () => {
  return (
    <section
      id="partners"
      className="py-20 bg-gradient-to-br from-[#f0f9ff] to-white dark:from-slate-900 dark:to-slate-800"
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300">
            We&apos;re deeply integrated with Bangladesh&apos;s top mobile
            operators and financial platforms
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
            Let&apos;s co-create solutions that drive revenue and user
            engagement across Bangladesh&apos;s diverse digital landscape.
          </p>
          <a
            href="#contact"
