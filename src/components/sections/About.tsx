      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300">
            ...
            solutions tailored for Bangladesh
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              MoMagic Bangladesh is a digital technology partner to telcos,
              banks, and service providers. We simplify mobile billing, enable
              direct carrier payments, and build smart platforms that reach
              every user — from smartphones to feature phones.
            </p>

            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              Whether you&apos;re launching an app or scaling a digital
              ecosystem, we bring the billing, tech, and telco access to make it
              work.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              ...
              <div className="bg-white dark:bg-slate-800/50 p-5 rounded-xl shadow-md transition-all hover:shadow-lg hover:-translate-y-1 border border-slate-100 dark:border-slate-700/50">
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm">
                  Deep partnerships with all major telcos in Bangladesh for
                  seamless billing and connectivity.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800/50 p-5 rounded-xl shadow-md transition-all hover:shadow-lg hover:-translate-y-1 border border-slate-100 dark:border-slate-700/50">
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm">
                  Solutions that work across smartphones, feature phones, and
                  web platforms.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800/50 p-5 rounded-xl shadow-md transition-all hover:shadow-lg hover:-translate-y-1 border border-slate-100 dark:border-slate-700/50">
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm">
                  ROI-driven solutions that contribute directly to business
                  growth and revenue.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800/50 p-5 rounded-xl shadow-md transition-all hover:shadow-lg hover:-translate-y-1 border border-slate-100 dark:border-slate-700/50">
                ...
                <p className="text-slate-600 dark:text-slate-300 text-sm">
                  Enterprise-grade security with robust compliance to industry
                  standards.
                </p>
              </div>
            </div>
